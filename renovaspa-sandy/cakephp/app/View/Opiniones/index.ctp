	...
	<div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				...
				<li class="active"><?php echo $this->Html->link(__('New Opinione'), array('action' => 'add')); ?></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="table-responsive">
	<h1 class="page-header"><?php echo __('Opiniones'); ?></h1>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $opinione['Opinione']['id']), array('class' => 'btn btn-xs btn-warning')); ?>
