	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Hotele->save($this->request->data)) {
				$this->Session->setFlash(__('The hotele has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The hotele could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Hotele->delete()) {
			$this->Session->setFlash(__('The hotele has been deleted.'));
		} else {
			$this->Session->setFlash(__('The hotele could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
}
